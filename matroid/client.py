...
class MatroidAPI(object):
  ...
  from matroid.src.detectors import create_detector, delete_detector, finalize_detector, train_detector, get_detector_info, detector_info, import_detector, redo_detector, search_detectors, list_detectors, add_feedback_from_file, add_feedback_from_url, delete_feedback
